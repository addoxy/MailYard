...
export const HowItWorksCard = ({
  ...
  return (
    <div className={cn('relative h-full', className)}>
      <div className="from-background/60 to-background/30 relative h-full overflow-hidden rounded-2xl border border-white/20 bg-gradient-to-br p-6 shadow-xl backdrop-blur-sm">
